package com.kryptkode.flashalerts.app.utils.share
...
class PlayStoreUtils @Inject constructor(private val activity: AppCompatActivity) {
    ...
    private fun openPlayStoreInBrowser(appPackageName: String) {
        ...
        activity.startActivity(
            Intent.createChooser(
                intent,
                activity.getString(R.string.open_playstore_with)
            )
        )
    }
    ...
    private fun resolvePlayStore(intent: Intent): ActivityInfo? {
        val otherAppsResolveInfo = activity.packageManager
