...
import com.kryptkode.flashalerts.app.utils.UriHelper
 ...
 */
class ShareUtils @Inject constructor(private val context: Context) {
    ...
    fun startShareApp() {
        context.startActivity(createShareAppIntent())
    }
