...
import com.kryptkode.flashalerts.app.utils.inappupdates.InAppUpdateConstants.UpdateMode
...
class InAppUpdateManager : LifecycleObserver {
    ...
    private fun init() {
        ...
        if (mode === UpdateMode.FLEXIBLE) appUpdateManager.registerListener(
    ...
    /**
     * Use custom notification for the user confirmation needed by the [InAppUpdateConstants.UpdateMode.FLEXIBLE] flow.
     ...
     * will start the update process with the selected [InAppUpdateConstants.UpdateMode].
     */
        ...
        appUpdateInfoTask.addOnSuccessListener { appUpdateInfo ->
            ...
            if (startUpdate) {
                if (appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE) {
                    ...
                    Timber.d(
                        "checkForAppUpdate(): Update available. Version Code: %s",
                        appUpdateInfo.availableVersionCode()
                    )
                } else if (appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_NOT_AVAILABLE) {
                    Timber.d(
                        "checkForAppUpdate(): No Update available. Code: %s",
    ...
    private fun startAppUpdateImmediate(appUpdateInfo: AppUpdateInfo) {
        try {
            ...
            reportUpdateError(InAppUpdateConstants.UPDATE_ERROR_START_APP_UPDATE_IMMEDIATE, e)
        }
    }
    ...
    private fun startAppUpdateFlexible(appUpdateInfo: AppUpdateInfo) {
        try {
            ...
            reportUpdateError(InAppUpdateConstants.UPDATE_ERROR_START_APP_UPDATE_FLEXIBLE, e)
        }
    }
        ...
        appUpdateManager.getAppUpdateInfo()
            .addOnSuccessListener { appUpdateInfo ->
                ...
                if (appUpdateInfo.installStatus() == InstallStatus.DOWNLOADED) {
                    ...
                    reportStatus()
                    Timber.d(
                        "checkNewAppVersionState(): resuming flexible update. Code: %s",
                        appUpdateInfo.updateAvailability()
                    )
                }
                ...
                if (appUpdateInfo.updateAvailability() == UpdateAvailability.DEVELOPER_TRIGGERED_UPDATE_IN_PROGRESS) {
                    ...
                    startAppUpdateImmediate(appUpdateInfo)
                    Timber.d(
                        "checkNewAppVersionState(): resuming immediate update. Code: %s",
                        appUpdateInfo.updateAvailability()
                    )
                }
            }
